...
| 25 | Explorer design parity — header actions, git letter lane, diagnostic dots + rollup, empty states | [spec-explorer-parity.md](spec-explorer-parity.md) | [Phase 250](https://github.com/skrischer/rift/milestone/39) |
| 26 | Settings shell + theme unification — full settings page, theme-driven terminal palette, hardcoded-hex cleanup | [spec-settings-theme.md](spec-settings-theme.md) | [Phase 260](https://github.com/skrischer/rift/milestone/40) |
